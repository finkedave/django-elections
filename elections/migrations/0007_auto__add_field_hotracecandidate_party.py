...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HotRaceCandidate.party'
        db.add_column('elections_hotracecandidate', 'party', self.gf('django.db.models.fields.CharField')(default='O', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HotRaceCandidate.party'
        db.delete_column('elections_hotracecandidate', 'party')
