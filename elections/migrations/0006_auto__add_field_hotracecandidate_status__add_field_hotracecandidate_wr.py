...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HotRaceCandidate.status'
        db.add_column('elections_hotracecandidate', 'status', self.gf('django.db.models.fields.CharField')(default='C', max_length=100), keep_default=False)

        # Adding field 'HotRaceCandidate.write_in_photo_fk'
        db.add_column('elections_hotracecandidate', 'write_in_photo_fk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['massmedia.Image'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HotRaceCandidate.status'
        db.delete_column('elections_hotracecandidate', 'status')

        # Deleting field 'HotRaceCandidate.write_in_photo_fk'
        db.delete_column('elections_hotracecandidate', 'write_in_photo_fk_id')
