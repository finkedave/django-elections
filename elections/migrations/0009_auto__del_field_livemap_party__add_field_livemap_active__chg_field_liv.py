...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LiveMap.active'
        db.add_column('elections_livemap', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Changing field 'LiveMap.office'
        db.alter_column('elections_livemap', 'office', self.gf('django.db.models.fields.CharField')(default='President', max_length=20))

        # Deleting field 'DelegateElection.party'
        db.delete_column('elections_delegateelection', 'party')


    def backwards(self, orm):
        
        # Adding field 'LiveMap.party'
        db.add_column('elections_livemap', 'party', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Deleting field 'LiveMap.active'
        db.delete_column('elections_livemap', 'active')

        # User chose to not deal with backwards NULL issues for 'DelegateElection.party'
        raise RuntimeError("Cannot reverse this migration. 'DelegateElection.party' and its values cannot be restored.")
    ...
    models = {
        ...
        'elections.delegateelection': {
            'Meta': {'ordering': "['-year', 'race_type']", 'object_name': 'DelegateElection'},
        ...
        'elections.livemap': {
            'Meta': {'ordering': "['-race_date', 'race_type', 'office']", 'object_name': 'LiveMap'},
            ...
            'office': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
