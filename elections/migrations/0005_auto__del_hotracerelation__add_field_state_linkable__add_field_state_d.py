...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'State.linkable'
        db.add_column('elections_state', 'linkable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'State.disabled'
        db.add_column('elections_state', 'disabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'State.linkable'
        db.delete_column('elections_state', 'linkable')

        # Deleting field 'State.disabled'
        db.delete_column('elections_state', 'disabled')

        # Adding field 'Candidate.photo_fk'
        db.add_column('elections_candidate', 'photo_fk', self.gf('django.db.models.fields.related.ForeignKey')(related_name='alternate_photo', null=True, to=orm['massmedia.Image'], blank=True), keep_default=False)

        # Adding field 'Candidate.thumbnail_fk'
        db.add_column('elections_candidate', 'thumbnail_fk', self.gf('django.db.models.fields.related.ForeignKey')(related_name='alternate_thumbnail', null=True, to=orm['massmedia.Image'], blank=True), keep_default=False)
