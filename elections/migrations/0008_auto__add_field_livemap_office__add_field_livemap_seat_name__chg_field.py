...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LiveMap.office'
        db.add_column('elections_livemap', 'office', self.gf('django.db.models.fields.CharField')(default='President', max_length=20), keep_default=False)

        # Adding field 'LiveMap.seat_name'
        db.add_column('elections_livemap', 'seat_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Changing field 'LiveMap.slug'
        db.alter_column('elections_livemap', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # Deleting field 'LiveMap.office'
        db.delete_column('elections_livemap', 'office')

        # Deleting field 'LiveMap.seat_name'
        db.delete_column('elections_livemap', 'seat_name')

        # User chose to not deal with backwards NULL issues for 'LiveMap.slug'
        raise RuntimeError("Cannot reverse this migration. 'LiveMap.slug' and its values cannot be restored.")
