...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LiveMap.uncontested'
        db.add_column('elections_livemap', 'uncontested', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'LiveMap.json_file_name'
        db.alter_column('elections_livemap', 'json_file_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting field 'LiveMap.uncontested'
        db.delete_column('elections_livemap', 'uncontested')

        # User chose to not deal with backwards NULL issues for 'LiveMap.json_file_name'
        raise RuntimeError("Cannot reverse this migration. 'LiveMap.json_file_name' and its values cannot be restored.")
